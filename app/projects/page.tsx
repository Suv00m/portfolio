...
const projects = [
  ...
  {
    title: "Search",
    description: "Minimal semantic search over documents using vector embeddings. Clean query interface, no fluff.",
  ...
  {
    title: "yuj-v1",
    description: "Fine-tuned text generation model trained with QLoRA and PEFT. Instruction-following on a constrained compute budget.",
    url: "https://huggingface.co/shuvom/yuj-v1",
    tags: ["PyTorch", "QLoRA", "PEFT", "HuggingFace"],
    year: "2025",
    status: "Open weights",
  },
  {
